...
#[AsCommand(
    ...
    description: 'Create a new domain notification',
)]
class MakeNotificationCommand extends PulsarCommand
{
    /**
    ...
    public function handle(): int
    {
        ...
        try {
            $filePath = (new NotificationGenerator($name, $domain))->generate();
    ...
    {
        $this->addArgument('name', InputArgument::REQUIRED, 'The name of the notification');
